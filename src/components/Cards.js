    ...
    return (
      ...
      <ReactBootStrap.Container center className="my-card-container">   
        ...
        <ReactBootStrap.Row xs={1} md={4} className="cards-row-1">
                <ReactBootStrap.Col>
                    <ReactBootStrap.Card className="card1">
                    <ReactBootStrap.Card.Img className="card1-img" src= "https://i.pinimg.com/originals/72/9a/10/729a103c5a7c328d7ea54730fb48b6d8.jpg" />
                        <ReactBootStrap.Card.Body className="card-body">
                            <ReactBootStrap.Card.Text className= "card-price">LKR 1000</ReactBootStrap.Card.Text>
                            <ReactBootStrap.Card.Title className="title">ANNA TODD <br/> After</ReactBootStrap.Card.Title>
                            <ReactBootStrap.Card.Text className="card-discription">
                                    Be the first one to write a review
                        </ReactBootStrap.Card.Text>                            
                            <div className="rating-group">
                ...
                <ReactBootStrap.Col>
                    <ReactBootStrap.Card className="card4">
                        <ReactBootStrap.Card.Img className="card4-img" src="https://s3images.coroflot.com/user_files/individual_files/original_496994_qaNJg7V3AiG3NpOLrzMsdUw3M.jpg" />
                        <ReactBootStrap.Card.Body className="card-body">
                        <ReactBootStrap.Card.Text className= "card-price">LKR 1000</ReactBootStrap.Card.Text>
                        <ReactBootStrap.Card.Title className="title" >J.R.R. TOLKIEN <br/> The Hobbit </ReactBootStrap.Card.Title>
                        <ReactBootStrap.Card.Text className="card-discription">
                                    Be the first one to write a review
                        </ReactBootStrap.Card.Text>                            
                            <div className="rating-group">
                ...
                <ReactBootStrap.Col>
                    <ReactBootStrap.Card className="card4">
                        <ReactBootStrap.Card.Img className="card4-img" src="https://www.getlitt.co/blog/wp-content/uploads/2019/05/list-of-2016-sherlock-holmes-books.jpg" />
                        <ReactBootStrap.Card.Body className="card-body">
                        <ReactBootStrap.Card.Text className= "card-price">LKR 1000</ReactBootStrap.Card.Text>
                        <ReactBootStrap.Card.Title className="title" >SHERLOCK HOLMES <br/> Study In Scarlet </ReactBootStrap.Card.Title>
                        <ReactBootStrap.Card.Text className="card-discription">
                                    Be the first one to write a review
                        </ReactBootStrap.Card.Text>                            
                            <div className="rating-group">
